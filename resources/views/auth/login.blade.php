@extends('layouts.app')
@section('content')
<div class="container mt-5 mb-2" style="border-radius:50px 0px 50px 0;">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 col-lg-6" style="border-radius:50px 0px 50px 0; background-color:white; ">
